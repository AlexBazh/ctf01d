...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServiceIdServiceBody', function() {
      beforeEach(function() {
        instance = new CtfManagementApi.ServiceIdServiceBody();
      });

      it('should create an instance of ServiceIdServiceBody', function() {
        // TODO: update the code to test ServiceIdServiceBody
        expect(instance).to.be.a(CtfManagementApi.ServiceIdServiceBody);
      });
