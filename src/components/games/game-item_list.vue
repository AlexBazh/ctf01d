...
export default {
    ...
    methods: {
      ...
      formatedObj(){
        this.editGameObj.start_time = this.game_data.startTime.slice(0, 16)
        this.editGameObj.end_time = this.game_data.endTime.slice(0, 16)
    ...
    computed: {
        dateStatus () {
            return moment(this.game_data.endTime).fromNow();
        },
        startDate(){
            return moment(this.game_data.startTime).format('LL');;
        },
        startTime(){
            return moment(this.game_data.startTime).format('LT');;
        },
        finishDate(){
            return moment(this.game_data.endTime).format('LL');;
        },
        finishTime(){
            return moment(this.game_data.endTime).format('LT');;
        }
    }
}
</script>
...
<template>
  ...
  <div class="game_list_item">
    <div class="game_list_item_description semi_14">{{ game_data.description }}</div>
